...
#ifndef _STRING_TO_INT_H_
#define _STRING_TO_INT_H_
...
static const unsigned int CONSTHASH_CONSTANTS[CONSTHASH_DEPTH+1] =
{
...
static const unsigned int CONSTHASH_MULTS[CONSTHASH_DEPTH+1] =
{
...
#define S2I(string) CONSTHASH_RECURSE_00(string, *string)
